...
namespace MortezazadehDCM
{
    ...
    public class EsiToField
    {
        ...
        // public  int EsiMetaType { get; set; }
        public EsiToMetaType EsiMetaType { get; set; }
    }
    ...
    public  class EsiToMetaType
    {
        ...
        public EsiToMetaType This { get { return this; } }
    ...
    public  class EsiToProduct
    {
        ...
        public virtual EsiToCategory EsiCategory { get; set; }
        public virtual ICollection<EsiToItem> EsiItems { get; set; }
    }
